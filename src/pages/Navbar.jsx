...
const navigation = [
  ...
  { name: 'Contact', to: '/contact', current: false }, // Adjusted route
  { name: 'Projects', to: '/projects', current: false }, // Adjusted route
  { name: 'About Me', to: '/aboutme', current: false }, // Adjusted route
  { name: 'Web Projects', to: '/web', current: false }, // Adjusted route
]
